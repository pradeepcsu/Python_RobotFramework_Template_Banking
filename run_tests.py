...
class Runner(object):
    ...
    def start_parallel(self):
        ...
        print('AUT Suite:  Name: {}  Test Count: {}'.format(suite_.name, suite_.test_count))
        ...
        print('Applying tags filter:  included: {}  excluded: {}'.format(self.include, self.exclude))
        ...
        rebot(*todos, merge=True, outputdir='./results/{}'.format(serial),
        ...
        for r in m:
            for ff in os.listdir('./results/{}/tests/{}'.format(serial, r)):
                if ff.lower().endswith('.png'):
                    shutil.copyfile('./results/{}/tests/{}/{}'.format(serial, r, ff),
